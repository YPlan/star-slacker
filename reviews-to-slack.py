...
googleBucket = 'pubsite_prod_rev_your-bucket-here' # You get this from the Reviews page in the Google Play Console
json_file = 'google-auth.json' # This is generated in the Admin Console and contains info for Google OAuth
apps = ["com.yplanapp", "co.cinemaclub", "com.yplanapp.access"] # Our apps
daysInPast = 1
